...
import { Tooltip, IconButton } from '@mui/material'; // Keep this line if Tooltip and IconButton are used directly in 1007.js
import { CondoCoopProjectsTable } from './tables';
import LibraryBooksIcon from '@mui/icons-material/LibraryBooks';
import ActionButtons from './ActionButtons';

import SalesComparisonSection from './SalesComparisonSection';
const Form1007 = ({ data, allData, extractionAttempted, handleDataChange,onCensusTractRevisionButtonClick,onViewRevisionButtonClick, onSanitarySewerButtonClick, onHighestAndBestUseClick, onAdverseSiteConditionsRevisionButtonClick, editingField, setEditingField, highlightedSubjectFields, highlightedContractFields,onLegalDescriptionUseClick ,onOffSiteImprovementsButtonClick, highlightedSiteFields, subjectFields, contractFields, neighborhoodFields, siteFields, improvementsFields, salesGridRows, comparableSales, salesHistoryFields , onAssessorsParcelNumberRevisionButtonClick, onOffSiteImprovementsClick, salesComparisonAdditionalInfoFields, reconciliationFields, costApproachFields, incomeApproachFields, pudInformationFields, marketConditionsRows, marketConditionsFields, appraiserFields,  condoCoopProjectsRows, condoForeclosureFields, comparableRents, RentSchedulesFIELDS2, rentScheduleReconciliationFields, formType, onAlleyClick, comparisonData, getComparisonStyle, infoOfSalesFields, loading, loadingSection,onNeighborhoodNameRevisionButtonClick , onStateRevisionButtonClick,handleStateRequirementCheck, stateReqLoading,  handleClientRequirementCheck, clientReqLoading, handleEscalationCheck, escalationLoading,  manualValidations, handleManualValidation, onSubjectRevisionButtonClick, onContractRevisionButtonClick, onNeighborhoodRevisionButtonClick, onSiteRevisionButtonClick, onImprovementsRevisionButtonClick, onSalesGridRevisionButtonClick, onReconciliationRevisionButtonClick, onCostApproachRevisionButtonClick, onCertificationRevisionButtonClick, on1007RevisionButtonClick, onAddRevision, onAddBorrowerRevision, onAddEmptyBorrowerRevision, onAddLegalDescRevision, onPropertyAddressRevisionButtonClick, onLenderClientRevisionButtonClick, onAddAssignmentTypeRevision, onAddPropertyRightsRevision, onHoaRevisionButtonClick, onAddParcelNumberRevision, onAddOwnerOfRecordRevision, onLenderClientAddressRevisionButtonClick, onContractPriceRevisionButtonClick, onDateOfContractRevisionButtonClick, onFinancialAssistanceRevisionButtonClick, onNeighborhoodBoundariesRevisionButtonClick, onOtherLandUseRevisionButtonClick, onZoningComplianceRevisionButtonClick, onAreaRevisionButtonClick, onFemaHazardRevisionButtonClick, onDimensionsRevisionButtonClick, onElectricityRevisionButtonClick ,onFEMAMapDateRevisionButtonClick ,onZoningRevisionButtonClick, onShapeRevisionButtonClick ,onSpecificZoningClassificationRevisionButtonClick, onGasRevisionButtonClick, ONFEMAMaprevisionButtonClick, onFEMAFloodZoneRevisionButtonClick,onOneWithAccessoryUnitRevisionButtonClick, onWaterRevisionButtonClick ,onDesignStyleRevisionButtonClick, onproposedUseRevisionButtonClick ,onExteriorWallsRevisionButtonClick}) => (
  ...
  <>
    ...
    />
    <SubjectInfoCard id="subject-info" title="Subject Information" fields={subjectFields} data={data} extractionAttempted={extractionAttempted} onDataChange={(field, value) => handleDataChange([field], value)} isEditable={true} editingField={editingField} setEditingField={setEditingField} highlightedFields={highlightedSubjectFields} allData={allData} comparisonData={comparisonData} getComparisonStyle={getComparisonStyle} loading={loading} loadingSection={loadingSection} manualValidations={manualValidations} handleManualValidation={handleManualValidation} onRevisionButtonClick={onSubjectRevisionButtonClick} onAddRevision={onAddRevision} onAddBorrowerRevision={onAddBorrowerRevision} onAddEmptyBorrowerRevision={onAddEmptyBorrowerRevision} onAddLegalDescRevision={onAddLegalDescRevision} onPropertyAddressRevisionButtonClick={onPropertyAddressRevisionButtonClick} onLenderClientRevisionButtonClick={onLenderClientRevisionButtonClick} onLegalDescriptionUseClick={onLegalDescriptionUseClick} onAddAssignmentTypeRevision={onAddAssignmentTypeRevision} onStateRevisionButtonClick={onStateRevisionButtonClick} onNeighborhoodNameRevisionButtonClick={onNeighborhoodNameRevisionButtonClick} onAddPropertyRightsRevision={onAddPropertyRightsRevision} onHoaRevisionButtonClick={onHoaRevisionButtonClick} onAddParcelNumberRevision={onAddParcelNumberRevision} onAddOwnerOfRecordRevision={onAddOwnerOfRecordRevision} onCensusTractRevisionButtonClick={onCensusTractRevisionButtonClick} onLenderClientAddressRevisionButtonClick={onLenderClientAddressRevisionButtonClick} onAssessorsParcelNumberRevisionButtonClick={onAssessorsParcelNumberRevisionButtonClick}/>
